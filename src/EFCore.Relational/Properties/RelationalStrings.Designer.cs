...
namespace Microsoft.EntityFrameworkCore.Internal
{
    ...
    public static class RelationalStrings
    {
        ...
        /// <summary>
        ///     A named connection string was used, but the name '{name}' was not found in the application's configuration. Note that named connection strings are only supported when using 'IConfiguration' and a service provider, such as in a typical ASP.NET Core application.
        /// </summary>
